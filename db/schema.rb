...
ActiveRecord::Schema.define(version: 20200415205627) do
  ...
  create_table "schedule_services", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["schedule_id"], name: "index_schedule_services_on_schedule_id", using: :btree
    t.index ["service_id"], name: "index_schedule_services_on_service_id", using: :btree
  end
